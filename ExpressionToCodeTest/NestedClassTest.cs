...
namespace ExpressionToCodeTest {
    ...
    class NestedClassTest {
        ...
        public void GenericNestedInGeneric() {
            ...
            Assert.Equal("() => null as ParentGen<Parent.NestedGen<object>>.NestedGen<string>", ExpressionToCode.ToCode(() => null as ParentGen<Parent.NestedGen<object>>.NestedGen<string>));
            Assert.Equal("() => null as ParentGen<int>.NestedGen<ParentGen<int>.Nested>", ExpressionToCode.ToCode(() => null as ParentGen<int>.NestedGen<ParentGen<int>.Nested>));
            Assert.Equal("() => null as ParentGen<ParentGen<int>.Nested>.NestedGen<ParentGen<int>.NestedGen<string>>", ExpressionToCode.ToCode(() => null as ParentGen<ParentGen<int>.Nested>.NestedGen<ParentGen<int>.NestedGen<string>>));
        }
    }
}
